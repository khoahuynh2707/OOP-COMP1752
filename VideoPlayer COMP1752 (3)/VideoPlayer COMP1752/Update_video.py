...
class UpdateVideo:
    ...
    def listall(self):
        ...
        self.status.configure(text="Showing All Videos")
    ...
    def displayinfo(self):
        ...
        if name is not None:
            ...
            errorID()
        self.status.configure(text="Checking Video successfully")
    ...
    def NewRating(self):
        ...
        if key:
            if newrate in self.ratingdtb:
                ...
                success()
                self.status.configure(text="Saved new rating successfully")
            else:
                errorReview()
                self.status.configure(text="No new rating was saved")
