...
class VideoLibraryApp:
    def __init__(self, window):
        ...
        window.configure(bg="#F0F8FF")  # Light Alice Blue background color
        
        # Create a notebook (tab control)
        self.notebook = ttk.Notebook(window)
        self.notebook.pack(expand=1, fill="both")
        
        # Create tabs with background color
        self.create_tab = ttk.Frame(self.notebook, style='Tab.TFrame')
        self.update_tab = ttk.Frame(self.notebook, style='Tab.TFrame')
        ...
        # Style configuration
        style = ttk.Style()
        style.configure('Tab.TFrame', background='#E6E6FA')  # Light Lavender
        style.configure('TButton', background='#ADD8E6', font=('Arial', 12))
        style.configure('TLabel', background='#E6E6FA', font=('Arial', 12))
        
        # Optionally configure a background image
    ...
    def create_video_ui(self):
        # Create tab UI with custom styling
        ...
        self.status_lbl = tk.Label(self.create_tab, text="", font=("Arial", 12))
    ...
    def update_video_ui(self):
        # Update tab UI with custom styling
        ...
        self.status_update_lbl = tk.Label(self.update_tab, text="", font=("Arial", 12))
